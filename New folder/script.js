// JavaScript للتفاعلات والتأثيرات الاحترافية
...
function initializePage() {
    ...
    const cards = document.querySelectorAll('.business-card, .info-section');
...
function addScrollEffects() {
    let lastScrollTop = 0;
    const navbar = document.querySelector('.interactive-navbar');
...
function addTouchEffects() {
    const buttons = document.querySelectorAll('.nav-btn, .cta-button, .social-link');
